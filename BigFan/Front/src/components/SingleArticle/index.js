  ...
  const content = (
    <View>
      {(article.content.length > 30 && (
        ...
        <Text style={{fontSize: 14, fontWeight: '400'}}>{article.content}</Text>
      )}
    </View>
  );

  return (
    <TouchableHighlight onPress={onPress} underlayColor="#3b3d3b">
      <View
        style={{
          // flexDirection: 'row',
        ...
        <View style={{marginBottom: 0}}>
          <Text style={{fontSize: 15, fontWeight: '700'}}>{article.title}</Text>
          {content}
        </View>
